...
//       <button
//         onClick={onBack}
//         className={`fixed top-4 left-4 z-50 px-3 py-2 sm:px-4 sm:py-2 rounded-lg shadow hover:shadow-md transition ${theme.button} flex items-center gap-1 sm:gap-2 text-sm sm:text-base`}
//       >
...
//       {/* Header */}
//       <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-40 text-center px-20">
//         <h1 className={`text-xl sm:text-2xl font-bold ${theme.text}`}>Audio Matching</h1>
//       </div>

//       {/* Progress bar */}
//       <div className="fixed top-14 sm:top-16 left-0 right-0 z-40 px-4 sm:px-8">
...
//               <Star className="inline w-3 h-3 sm:w-4 sm:h-4" fill="currentColor" /> {score}/{shuffledExercises.length}
//             </span>
//           </div>
...
//       {/* Main content */}
//       <div className="absolute inset-0 pt-32 pb-40 sm:pb-8 flex flex-col items-center justify-start sm:justify-center overflow-y-auto">
//         <div className="space-y-6 sm:space-y-8 max-w-2xl w-full px-4 sm:px-8 mt-8 sm:mt-0">
//           {/* Instruction and replay button */}
//           <div className="text-center space-y-4">
//             <p className={`text-lg sm:text-xl ${theme.textSecondary} px-4`}>
//               Listen to the sound and select the matching letter
//             </p>
//             <button
//               onClick={playSound}
//               className={`${theme.card} p-5 sm:p-6 rounded-full hover:scale-110 transition-transform shadow-lg`}
//             >
//               <Volume2 className={`w-10 h-10 sm:w-12 sm:h-12 ${theme.accent}`} />
//             </button>
//           </div>

//           {/* Answer options */}
//           <div className="grid grid-cols-2 gap-4 max-w-lg sm:max-w-2xl mx-auto">
...
//                   disabled={!!feedback}
//                   className={`${buttonStyle} p-6 sm:p-8 rounded-2xl sm:rounded-3xl text-5xl sm:text-6xl font-bold hover:scale-105 transition-all shadow-lg disabled:cursor-not-allowed min-h-[110px] sm:min-h-[140px] flex items-center justify-center`}
//                 >
...
//       {/* Feedback */}
//       {feedback && (
//         <div className={`fixed bottom-20 sm:bottom-8 left-1/2 transform -translate-x-1/2 z-50 px-4 py-3 sm:px-6 sm:py-4 rounded-xl shadow-lg mx-4 ${
//           feedback === 'correct' ? 'bg-green-500 text-white' : 'bg-red-500 text-white'
//         }`}>
//           <div className="flex items-center gap-2">
//             {feedback === 'correct' ? <Check className="w-5 h-5 sm:w-6 sm:h-6" /> : <X className="w-5 h-5 sm:w-6 sm:h-6" />}
